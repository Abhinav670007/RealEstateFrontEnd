...
function SignIn() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      <h1 className='text-3xl text-center font-semibold my-7 overflow-y-hidden pb-3'>SignIn</h1>
      <form className='flex flex-col gap-4' onSubmit={handlesubmit}>
        ...
        <button className='bg-slate-600 text-white p-3 rounded uppercase hover:opacity-95 disabled:opacity-80'>Sign IN</button>
        <OAuth/>
      </form>
